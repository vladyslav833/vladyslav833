...
class custom_wpdb {
	...
	/**
	 * Format specifiers for DB columns. Columns not listed here default to %s. Initialized during CMS load.
	 *
    ...
    /**
     * Global param of debugging process
     *
     * @access public
     * @var string
     */
...
<p>If you're unsure what these terms mean you should probably contact your host. If you still need help you can contact development team.</p>
